...
// Date mapping for NYC trip Jan 14-18, 2025
const DATE_MAP = {
  'jan 14': '2025-01-14', 'january 14': '2025-01-14', 'tuesday': '2025-01-14', 'tue': '2025-01-14',
  'jan 15': '2025-01-15', 'january 15': '2025-01-15', 'wednesday': '2025-01-15', 'wed': '2025-01-15',
  'jan 16': '2025-01-16', 'january 16': '2025-01-16', 'thursday': '2025-01-16', 'thu': '2025-01-16',
  'jan 17': '2025-01-17', 'january 17': '2025-01-17', 'friday': '2025-01-17', 'fri': '2025-01-17',
  'jan 18': '2025-01-18', 'january 18': '2025-01-18', 'saturday': '2025-01-18', 'sat': '2025-01-18'
};
  ...
  async function executeUpdateItinerary(args, userId, context = {}) {
    ...
    try {
      if (action === 'add') {
        ...
        // Trigger background enrichment if callback provided
        if (context.triggerEnrichment) {
          context.triggerEnrichment(userId);
        }
      ...
      if (action === 'update') {
        ...
        if (day) {
          ...
          const currentDays = await db.getDaysByDateRange(userId, '2025-01-14', '2025-01-18');
          ...
          if (targetDateStr !== currentDateStr) {
            ...
            if (currentItem.enrichment) {
              ...
              // No enrichment existed, trigger background enrichment
              if (context.triggerEnrichment) {
                context.triggerEnrichment(userId);
              }
            }
